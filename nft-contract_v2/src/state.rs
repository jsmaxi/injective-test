...
pub struct Config {
    ...
    pub mint_fee: Uint128, // Default mint fee in INJ tokens
    pub creator: Addr,     // Contract creator address
}
...
pub const BOUGHT_NFTS: Map<(&Addr, &str), bool> = Map::new("bought_nfts");
